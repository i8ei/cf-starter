...
このテンプレートから生まれた実アプリです。

| アプリ | 概要 | 構成 |
|--------|------|------|
| [補助金スカウト](https://tara-grant-scout.ichevi.workers.dev) | 全省庁の補助金を毎日AI解析して届ける | 公開・認証なし |
| ボランティアタクシー | 有償ボランティア輸送の配車〜清算管理 | Record Engine フル活用 |
| 太良町公共施設 空き状況 | 公共施設28箇所の予約・空き状況管理 | 閲覧=公開 / 管理=認証あり |

3本とも本番稼働中。実戦フィードバック3周を経て v1.0.0 に到達しました。
