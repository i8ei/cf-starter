      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex gap-3 pt-2">
          <button
            type="submit"
            disabled={isPending}
            className="inline-flex items-center rounded-xl bg-amber-400 px-6 py-3 font-semibold text-slate-950 disabled:opacity-50"
          >
            {isPending ? (
              <>
          ...
          <button
            type="button"
            onClick={() => navigate(`/${def.key}`)}
            className="rounded-xl bg-white/5 px-6 py-3 font-semibold text-slate-300"
          >
            Cancel
          </button>
        </div>
